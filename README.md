...
Đội ngũ 10 chuyên gia AI tinh nhuệ được thiết kế cho Google Antigravity. 100% Tiếng Việt.
...
| :--- | :--- | :--- |
| **`@tech-lead`** | Tech Lead | Kiến trúc hệ thống & Điều phối kỹ thuật |
| **`@frontend`** | Frontend Developer | Phát triển giao diện & Trải nghiệm người dùng |
| **`@backend`** | Backend Architect | Dịch vụ máy chủ & Nền tảng API |
| **`@database`** | Database Specialist | Thiết kế cơ sở dữ liệu & Tối ưu truy vấn |
| **`@designer`** | UI/UX Designer | Thiết kế hệ thống giao diện & Trải nghiệm thị giác |
| **`@code-reviewer`** | Code Reviewer | Thẩm định mã nguồn & Chuẩn mực chất lượng code |
...
./setup.sh uninstall   # Gỡ bỏ khỏi máy
```
